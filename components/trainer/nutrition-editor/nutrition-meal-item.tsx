...
import { Flame, Beef, Wheat, Droplets, Trash2, Loader2 } from "lucide-react"
...
export function NutritionMealItem({
  meal, index, isReadOnly, isRemoving, onRemove,
}: NutritionMealItemProps) {
